...
def consulta():
    ...
    adjetivos = random.choices(lista, k=len(df))  # Selección de adjetivos aleatorios en función del número de filas
    df['adjetivo'] = adjetivos
    df[['ciudad', 'adjetivo']] = df['ciudad'].str.split(' ', 1, expand=True)
